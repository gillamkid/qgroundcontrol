...
void CustomPlugin::paletteOverride(QString colorName, QGCPalette::PaletteColorInfo_t& colorInfo)
{
    if (colorName == QStringLiteral("window")) {
        ...
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupEnabled]   = QColor("#777777");
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupDisabled]  = QColor("#777777");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#777777");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupDisabled] = QColor("#777777");
    }
